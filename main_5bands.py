...
class Vignet(tf.keras.Model):
    def __init__(self, brain_channels=17):
        ...
        self.conv1 = tf.keras.layers.Conv2D(10, (1, 2), kernel_regularizer=self.regularizer, activation=self.activation)
        self.conv2 = tf.keras.layers.Conv2D(10, (1, 2), kernel_regularizer=self.regularizer, activation=self.activation)
        self.conv3 = tf.keras.layers.Conv2D(10, (1, 2), kernel_regularizer=self.regularizer, activation=self.activation)
        ...
        self.conv_depthwise1 = tf.keras.layers.DepthwiseConv2D((1, 2), kernel_regularizer=self.regularizer,
                                                               activation=None)
        self.conv_depthwise2 = tf.keras.layers.DepthwiseConv2D((1, 2), kernel_regularizer=self.regularizer,
                                                               activation=None)
        self.conv_depthwise3 = tf.keras.layers.DepthwiseConv2D((1, 2), kernel_regularizer=self.regularizer,
                                                               activation=None)
...
class Attention(tf.keras.Model):
    def __init__(self, source_num):
        ...
        self.atten_conv1 = tf.keras.layers.Conv2D(filters=10, kernel_size=(1, 3), kernel_regularizer=self.regularizer,
                                                  activation=self.activation)
